...
Version  : 1.0.2
Release  : 1
URL      : file:///aot/build/clearlinux/packages/IFRExtractor-RS/IFRExtractor-RS-v1.0.2.tar.gz
Source0  : file:///aot/build/clearlinux/packages/IFRExtractor-RS/IFRExtractor-RS-v1.0.2.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: IFRExtractor-RS-bin = %{version}-%{release}
...
%package bin
Summary: bin components for the IFRExtractor-RS package.
Group: Binaries

%description bin
bin components for the IFRExtractor-RS package.


%prep
%setup -q -n IFRExtractor-RS
cd %{_builddir}/IFRExtractor-RS
...
export CARGO_HTTP_CAINFO=/var/cache/ca-certs/anchors/ca-certificates.crt
export CARGO_TARGET_DIR=target
cargo install %{?_smp_mflags} --all-features --offline --no-track --verbose --path . --target-dir target --root %{buildroot}/usr/
